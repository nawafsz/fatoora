      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-semibold text-[#0d2818] mb-2">{dict.settings.commercialReg}</label>
              <input
                type="text"
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm space-y-5">
          ...
          <div>
            ...
            {form.zatcaEnv === "production" && (
              <div className="mt-2 bg-amber-50 border border-amber-100 rounded-lg px-4 py-2.5 text-xs text-amber-700">
