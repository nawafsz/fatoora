  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-black text-[#0d2818] mb-2">{dict?.common?.error ?? "خطأ"}</h1>
        <p className="text-gray-500 text-sm mb-8">{dict?.common?.networkError ?? "حدث خطأ غير متوقع"}</p>
        <button
          onClick={reset}
